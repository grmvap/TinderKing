...
public class TinderBoltApp extends MultiSessionTelegramBot {
    public static final String TELEGRAM_BOT_NAME = "t.me/TinderKing7_bot"; //TODO: добавь имя бота в кавычках
    public static final String TELEGRAM_BOT_TOKEN = "7520333162:AAFJo-EL9Vc6p_WGzBdDaSuzYvsHmG5jbp8"; //TODO: добавь токен бота в кавычках
    ...
    public void onUpdateEventReceived(Update update) {
        ...
        if (currentMode == DialogMode.GPT && !isMessageCommand()) {
            ...
            Message mess = sendTextMessage("Подождите пару секунд - ChatGPT думает...");
            String answer = chatGPT.sendMessage(prompt, message);
            updateTextMessage(mess, answer);
            return;
        }
        //command DATE
        ...
        if (currentMode == DialogMode.DATE && !isMessageCommand()) {
            ...
            Message mess = sendTextMessage("Подождите, девушка набирает текст...");
        ...
        if (message.equals("/profile")) {
            ...
            me = new UserInfo();
            questionCount = 1;
            sendTextMessage("Склько вам лет?");
            return;
        }
        ...
        if (currentMode == DialogMode.PROFILE && !isMessageCommand()) {
            switch (questionCount) {
                ...
                case 4:
                    me.annoys = message;
                    questionCount = 5;
                    sendTextMessage("Цель знакомтсва?");
                    return;
                case 5:
                    me.goals = message;
